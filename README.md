...
| [**KINDX**](https://github.com/ambicuity/KINDX) | Local-first hybrid cli search engine (BM25 + Vector) for per... | `TypeScript` | 0 | 1 |
...
*This profile README is automatically updated using GitHub Actions - Last updated: <!-- LAST_UPDATED_START -->2026-03-20<!-- LAST_UPDATED_END -->*

...
|---------------|-----------------|-------------|----------|----------|
| [**New-Grad-Jobs**](https://github.com/ambicuity/New-Grad-Jobs) | Welcome to New-Grad Jobs, a curated repository designed to h... | `Python` | 23 | 25 |
...
| [**Awesome-MICCAI-2026**](https://github.com/ambicuity/Awesome-MICCAI-2026) | This repository automatically discovers and organizes MICCAI... | `Python` | 12 | 0 |
| [**terraform-aws-eks-ray**](https://github.com/ambicuity/terraform-aws-eks-ray) | Production-grade, highly scalable Terraform module for deplo... | `Python` | 2 | 5 |
...
*This profile README is automatically updated using GitHub Actions - Last updated: <!-- LAST_UPDATED_START -->2026-04-27<!-- LAST_UPDATED_END -->*

...
|---------------|-----------------|-------------|----------|----------|
| [**KINDX**](https://github.com/ambicuity/KINDX) | Local-first hybrid cli search engine (BM25 + Vector) for per... | `TypeScript` | 0 | 2 |
| [**New-Grad-Jobs**](https://github.com/ambicuity/New-Grad-Jobs) | Welcome to New-Grad Jobs, a curated repository designed to h... | `Python` | 16 | 25 |
...
| [**terraform-aws-eks-ray**](https://github.com/ambicuity/terraform-aws-eks-ray) | Production-grade, highly scalable Terraform module for deplo... | `Python` | 1 | 5 |
| [**gujarati-python**](https://github.com/ambicuity/gujarati-python) | ગુજરાતી પાઈથન (Gujarati Python) એક ઓપન-સોર્સ પ્રોજેક્ટ છે, જ... | `Python` | 0 | 4 |
...
*This profile README is automatically updated using GitHub Actions - Last updated: <!-- LAST_UPDATED_START -->2026-03-27<!-- LAST_UPDATED_END -->*
